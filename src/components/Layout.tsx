    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white border-b sticky top-0 z-10">
        <div className="container mx-auto py-3 px-4 flex flex-col md:flex-row items-center gap-4">
          <Link to="/" className="text-2xl font-bold text-primary">DanishCompanyData</Link>
      ...
      <footer className="bg-white border-t mt-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">DanishCompanyData</h3>
          ...
          <div className="text-center text-muted-foreground text-sm pt-8 mt-8 border-t">
            © 2025 DanishCompanyData. All data sourced from public registries.
          </div>
        </div>
      </footer>
    </div>
