...
const KeyInformationCard: React.FC<KeyInformationCardProps> = ({ company, legalForm }) => {
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <h3 className="text-lg font-semibold mb-4 pb-2 border-b">Nøgleinformation</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
        <div className="flex flex-col">
          <span className="text-sm font-medium text-muted-foreground">Virksomhedstype</span>
        ...
        {company.employeeCount > 0 && (
          <div className="flex flex-col">
            <span className="text-sm font-medium text-muted-foreground">Medarbejdere</span>
