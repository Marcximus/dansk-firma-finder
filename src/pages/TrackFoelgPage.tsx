              ...
              <CardContent className="pt-4 flex flex-col flex-grow">
                <div className="text-center mb-6 pb-4 border-b border-border">
                  <div className="relative mb-1">
                    ...
                    <div className="absolute top-0 right-30 text-sm text-muted-foreground line-through opacity-70">{SUBSCRIPTION_TIERS.standard.originalPrice},-</div>
                  </div>
              ...
              <CardContent className="pt-4 flex flex-col flex-grow">
                <div className="text-center mb-6 pb-4 border-b border-border">
                  <div className="relative mb-1">
                    ...
                    <div className="absolute top-0 right-30 text-sm text-muted-foreground line-through opacity-70">{SUBSCRIPTION_TIERS.premium.originalPrice},-</div>
                  </div>
                  <div className="text-sm text-muted-foreground">pr. måned</div>
                </div>
                <ul className="space-y-3 mb-8 flex-grow">
              ...
              <CardContent className="pt-4 flex flex-col flex-grow">
                <div className="text-center mb-6 pb-4 border-b border-border">
                  <div className="relative mb-1">
                    ...
                    <div className="absolute top-0 right-30 text-sm text-muted-foreground line-through opacity-70">{SUBSCRIPTION_TIERS.enterprise.originalPrice},-</div>
                  </div>
                  <div className="text-sm text-muted-foreground">pr. måned</div>
                </div>
                <ul className="space-y-3 mb-8 flex-grow">
